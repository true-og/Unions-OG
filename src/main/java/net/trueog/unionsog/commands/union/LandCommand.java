...
@CommandAlias("%union")
@Subcommand("%land")
@Conditions("%basic_conditions|union_member|land_sharing|own_land")
...
public class LandCommand extends BaseCommand {
    ...
    private Set<Land> getLands(UnionPlayer cp, Location location) {
    ...
    public class AllowCommand extends BaseCommand {
        ...
        private void allow(UnionPlayer cp, ProtectionManager.Action action, Location location) {

            allow(cp, action, location, true);

        }

        private void allow(UnionPlayer cp, ProtectionManager.Action action, Location location, boolean notify) {
        ...
        public void container(Player player, UnionPlayer cp) {
        ...
        public void place(Player player, UnionPlayer cp) {
        ...
        public void damage(Player player, UnionPlayer cp) {
        ...
        public void interactEntity(Player player, UnionPlayer cp) {
        ...
        public void interact(Player player, UnionPlayer cp) {
        ...
        public void allowBreak(Player player, UnionPlayer cp) {
        ...
        public void all(Player player, UnionPlayer cp) {
    ...
    public class BlockCommand extends BaseCommand {
        ...
        private void block(UnionPlayer cp, ProtectionManager.Action action, Location location) {

            block(cp, action, location, true);

        }

        private void block(UnionPlayer cp, ProtectionManager.Action action, Location location, boolean notify) {
        ...
        public void blockBreak(Player player, UnionPlayer cp) {
