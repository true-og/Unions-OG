...
public class UnionCoords extends Sendable {

    private final Player player;
    private final Union union;

    public UnionCoords(@NotNull UnionsOG plugin, @NotNull Player player, @NotNull Union union) {
    ...
    private void populateRows() {
        ...
        for (UnionPlayer cpm : VanishUtils.getNonVanished(player, union)) {
    ...
    private void configureAndSendHeader() {
        ...
        ChatBlock.saySingle(player,
                sm.getColored(PAGE_UNION_NAME_COLOR) + union.getName() + subColor + " " + lang("coords", player) + " "
