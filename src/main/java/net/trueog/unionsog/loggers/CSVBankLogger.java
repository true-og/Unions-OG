...
import static net.trueog.unionsog.managers.SettingsManager.ConfigField.DEBUG;
import static net.trueog.unionsog.managers.SettingsManager.ConfigField.ECONOMY_BANK_LOG_ENABLED;
...
public class CSVBankLogger implements BankLogger {
    ...
    public CSVBankLogger(UnionsOG plugin) {
