package net.trueog.unionsog.language;
...
public class LanguageResource {
    ...
    private static final ResourceLoader DATA_FOLDER_LOADER = new ResourceLoader(UnionsOG.getInstance().getDataFolder());
    ...
    public LanguageResource() {
        ...
        this.defaultLocale = UnionsOG.getInstance().getSettingsManager().getLanguage();
    ...
    public String getLang(@NotNull String key, @NotNull Locale locale) {
        ...
        try {
            ...
            ResourceBundle bundle = ResourceBundle.getBundle("messages", locale,
                    UnionsOG.getInstance().getClass().getClassLoader(), new ResourceControl(defaultLocale));
    ...
    private static void loadTranslationStatus(@NotNull Locale locale, @NotNull String fileName) {
        ...
        InputStream stream = UnionsOG.getInstance().getClass().getResourceAsStream("/" + fileName);
        if (stream == null)
            return;
