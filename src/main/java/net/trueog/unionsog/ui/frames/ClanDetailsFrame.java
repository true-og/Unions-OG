...
public class ClanDetailsFrame extends SCFrame {
    ...
    private void addRank() {
        ...
        rank.setPermission(ClickType.LEFT, "unionsog.leader.rank.list");
        add(rank);
    ...
    private void addDisband() {
        ...
        disband.setPermission(ClickType.DROP, "unionsog.leader.disband");
    ...
    private void addBank() {
        ...
        bank.setPermission(ClickType.DROP, "unionsog.leader.withdraw-toggle");
        bank.setListener(ClickType.RIGHT, () -> InventoryController.runSubcommand(getViewer(), "toggle deposit", true));
        bank.setPermission(ClickType.RIGHT, "unionsog.leader.deposit-toggle");
    ...
    private void addRegroup() {
        ...
        if (price != 0)
            lore.add(
                    lang("gui.clandetails.regroup.lore.price", getViewer(), CurrencyFormat.format(price, getViewer())));
    ...
    private void addHome() {
        ...
        List<String> lore = new ArrayList<>();
        if (homePrice != 0)
            lore.add(lang("gui.clandetails.home.lore.teleport.price", getViewer(),
                    CurrencyFormat.format(homePrice, getViewer())));
        lore.add(lang("gui.clandetails.home.lore.teleport", getViewer()));
        if (setPrice != 0)
            lore.add(lang("gui.clandetails.home.lore.set.price", getViewer(),
