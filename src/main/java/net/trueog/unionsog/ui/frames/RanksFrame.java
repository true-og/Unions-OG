...
public class RanksFrame extends SCFrame {
    ...
    public void createComponents() {
        ...
        create.setPermission(ClickType.LEFT, "unionsog.leader.rank.create");
        add(create);
        ...
        for (int i = paginator.getMinIndex(); paginator.isValidIndex(i); i++) {
            ...
            if (toEdit != null) {
                ...
                c.setPermission(ClickType.LEFT, "unionsog.leader.rank.assign");

            } else {

                c.setListener(ClickType.LEFT,
                        () -> InventoryDrawer.open(new PermissionsFrame(this, getViewer(), rank)));
                c.setPermission(ClickType.LEFT, "unionsog.leader.rank.permissions.list");
                ...
                c.setPermission(ClickType.RIGHT, "unionsog.leader.rank.delete");
