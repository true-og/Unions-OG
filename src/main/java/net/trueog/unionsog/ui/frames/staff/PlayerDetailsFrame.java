...
public class PlayerDetailsFrame extends SCFrame {
    ...
    private void addPurge() {
        ...
        purge.setPermission(ClickType.LEFT, "unionsog.admin.purge");
        add(purge);
    ...
    private void addResetKDR() {
        ...
        resetKdr.setPermission(ClickType.LEFT, "unionsog.admin.resetkdr");
        add(resetKdr);
    ...
    private void addBanUnban() {
        ...
        banUnban.setPermission(ClickType.LEFT, "unionsog.mod.ban");
        banUnban.setPermission(ClickType.RIGHT, "unionsog.mod.ban");
