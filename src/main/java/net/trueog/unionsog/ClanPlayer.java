...
public class ClanPlayer implements Serializable, Comparable<ClanPlayer> {
    ...
    public boolean isAlly(Player player) {
        ...
        ClanPlayer allycp = UnionsOG.getInstance().getClanManager().getClanPlayer(player);
    ...
    public void setBbEnabled(boolean bbEnabled) {
        ...
        UnionsOG.getInstance().getStorageManager().updateClanPlayer(this);
    ...
    public void setTagEnabled(boolean tagEnabled) {
        ...
        UnionsOG.getInstance().getStorageManager().updateClanPlayer(this);
        UnionsOG.getInstance().getClanManager().updateDisplayName(toPlayer());
