...
1. Open TAB's config and edit the Groups section adding `%simpleunions_clan_color_tag%` to `belowname`:
...
_OTHER_:
 ...
 belowname: "&l&b[ %simpleunions_clan_color_tag% &l&b]"
```
{% endcode %}
